...
public static function getCatalogs($response1,$xApiKey,$clientId,$filter,$param,$value){
...
public static function getStores($response1,$xApiKey,$clientId,$filter,$param,$value){
...
public static function getCategories($response1,$xApiKey,$clientId,$filter,$param,$value){
