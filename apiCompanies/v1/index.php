...
Flight::route('GET /getCalendarDays/@headerslink/@filter', function ($headerslink,$filter) {
    ...
    if (!empty($apiKey) && !empty($xApiKey)) {
      ...
      curl_close($curl);
        ...
        if ($response1 != 'false' ) {
            ...
            $response = file_get_contents($sub_domain.'/kairosCore/apiCompanies/v1/getCalendarDays/'.$filter, false, $context);
...
Flight::route('GET /getClientRooms/@headerslink/@filter', function ($headerslink,$filter) {
...
Flight::route('GET /getCalendarDaysAssign/@headerslink/@filter', function ($headerslink,$filter) {
    ...
    if (!empty($apiKey) && !empty($xApiKey)) {
      ...
      curl_close($curl);
        ...
        if ($response1 != 'false' ) {
            ...
            // Realizar la solicitud y obtener la respuesta
            $response = file_get_contents($sub_domain.'/kairosCore/apiCompanies/v1/getCalendarDaysAssign/'.$filter, false, $context);
