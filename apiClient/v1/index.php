...
Flight::route('POST /postProduct/@apk/@xapk', function ($apk,$xapk) {
    ...
    if (!empty($apk) && !empty($xapk)) {
      ...
      $url = $sub_domain1."/kairosCom/apiClient/v1/postProduct/$apk/$xapk";
...
Flight::route('POST /postCatalog/@apk/@xapk', function ($apk,$xapk) {
    ...
    if (!empty($apk) && !empty($xapk)) {
      ...
      curl_close($curl);
      $sub_domain1=$sub_domaincon->domCom();
      $url = $sub_domain1."/kairosCom/apiClient/v1/postCatalog/$apk/$xapk";
...
Flight::route('POST /postCategorie/@apk/@xapk', function ($apk,$xapk) {
    ...
    if (!empty($apk) && !empty($xapk)) {
      ...
      curl_close($curl);
      $sub_domain1=$sub_domaincon->domCom();
      $url = $sub_domain1."/kairosCom/apiClient/v1/postCategorie/$apk/$xapk";
...
Flight::route('POST /putProduct/@apk/@xapk', function ($apk,$xapk) {
    ...
    if (!empty($apk) && !empty($xapk)) {
      ...
      curl_close($curl);
      $sub_domain1=$sub_domaincon->domCom();
      $url = $sub_domain1."/kairosCom/apiClient/v1/putProduct/$apk/$xapk";
