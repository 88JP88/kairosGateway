...
Flight::route('GET /getInternalUsersClient/@headerslink/@filter/@cid', function ($headerslink,$filter,$cid) {
...
Flight::route('GET /getInternalUsers/@headerslink/@filter', function ($headerslink,$filter) {
    ...
    if (!empty($apiKey) && !empty($xApiKey)) {
      ...
      curl_close($curl);
        ...
        if ($response1 != 'false' ) {
            ...
            // Realizar la solicitud y obtener la respuesta
            $response = file_get_contents($sub_domain.'/kairosCore/apiCore/v1/getInternalUsers/'.$filter, false, $context);
...
Flight::route('GET /getGeneralUsers/@headerslink/@filter/@user', function ($headerslink,$filter,$user) {
    ...
    if (!empty($apiKey) && !empty($xApiKey)) {
      ...
      curl_close($curl);
        ...
        if ($response1 != 'false' ) {
            ...
            // Realizar la solicitud y obtener la respuesta
            $response = file_get_contents($sub_domain.'/kairosCore/apiCore/v1/getGeneralUsers/'.$filter.'/'.$user, false, $context);
...
Flight::route('GET /getInternalClientsClient/@headerslink/@filter/@cid', function ($headerslink,$filter,$cid) {
    ...
    if (!empty($apiKey) && !empty($xApiKey)) {
      ...
      curl_close($curl);
        ...
        if ($response1 != 'false' ) {
            ...
            // Realizar la solicitud y obtener la respuesta
            $response = file_get_contents($sub_domain.'/kairosCore/apiCore/v1/getInternalClientsClient/'.$filter.'/'.$cid, false, $context);
...
Flight::route('GET /getClientStyle/@headerslink/@filter', function ($headerslink,$filter) {
    ...
    if (!empty($apiKey) && !empty($xApiKey)) {
      ...
      curl_close($curl);
        ...
        if ($response1 != 'false' ) {
            ...
            // Realizar la solicitud y obtener la respuesta
            $response = file_get_contents($sub_domain.'/kairosCore/apiCore/v1/getClientStyle/'.$filter, false, $context);
...
// Crear el array con los valores correspondientes
      ...
      curl_close($curl);
      $url = $sub_domain.'/kairosCore/apiCore/v1/validateLogOutClient/'.$headerslink;
